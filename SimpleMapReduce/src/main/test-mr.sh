...
../mrsequential ../../mrapps/wc.so ../test-files/pg*txt || exit 1
sort mr-out-0 > mr-correct-wc.txt
rm -f mr-out*

echo '***' Starting wc test.

$TIMEOUT ../mrcoordinator ../test-files/pg*txt &
pid=$!
...
# generate the correct output
../mrsequential ../../mrapps/indexer.so ../test-files/pg*txt || exit 1
...
($TIMEOUT ../mrcoordinator ../test-files/pg*txt ; touch $DF) &
...
# generate the correct output
../mrsequential ../../mrapps/nocrash.so ../test-files/pg*txt || exit 1
sort mr-out-0 > mr-correct-crash.txt
rm -f mr-out*

rm -f mr-done
($TIMEOUT ../mrcoordinator ../test-files/pg*txt ; touch mr-done ) &
sleep 1
